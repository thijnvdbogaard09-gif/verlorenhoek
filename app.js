const screensEl = document.getElementById('screens');
  ...
  const MAP_DE = {
    ...
    "Een weekendje weg, familieweekend of groepsuitje — bij Hans en Eric van den Bogaard is iedereen welkom, jong of oud.":"Ein Wochenende weg, ein Familienwochenende oder ein Gruppenausflug — bei Hans und Eric van den Bogaard ist jeder willkommen, jung oder alt.",
    ...
    "Hier kunnen alle zorgmiddelen worden verstrekt.":"Hier können alle Pflegehilfsmittel bereitgestellt werden.",
  ...
  const MAP_EN = {
    ...
    "Een weekendje weg, familieweekend of groepsuitje — bij Hans en Eric van den Bogaard is iedereen welkom, jong of oud.":"A weekend away, family weekend or group outing — at Hans and Eric van den Bogaard's, everyone is welcome, young or old.",
    ...
    "Hier kunnen alle zorgmiddelen worden verstrekt.":"All care aids can be provided here.",
